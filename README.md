...
- To change the schedule, edit the **cron** expression under **schedule** in `.github/workflows/01_airplaneManager.yml`. Use [crontab.guru](https://crontab.guru/) to generate your desired cron expression.
